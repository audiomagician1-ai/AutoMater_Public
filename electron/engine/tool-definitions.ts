...
export const TOOL_DEFINITIONS: ToolDef[] = [
  ...
  // ═══════════════════════════════════════════════════
  // v22.0: Admin Mode — 项目管理工具 (管家管理模式专用)
  // ═══════════════════════════════════════════════════

  {
    name: 'admin_list_members',
    description: '列出当前项目的所有团队成员及其配置（角色、名字、模型、提示词、上下文限制等）。管理模式下首先调用此工具了解当前团队构成。',
    parameters: {
      type: 'object',
      properties: {},
    },
  },
  {
    ...
    parameters: {
      ...
      properties: {
        ...
        capabilities: { type: 'array', items: { type: 'string' }, description: '能力标签列表（如 ["typescript","react"]）' },
