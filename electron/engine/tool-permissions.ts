...
const ROLE_TOOLS: Record<AgentRole, string[]> = {
  pm: [
    ...
    'read_many_files',
    'repo_map',
    'code_graph_query', // v17.0: 高级搜索
    // v5.5: PM 需要读文件能力 (分析用户提到的本地工程)
    'web_search',
    'fetch_url',
    'web_search_boost',
    'deep_research',
    'configure_search', // v8.0
    'download_file',
    'search_images', // v19.0
    'generate_image',
    'configure_image_gen', // v9.0
    'memory_read',
    'memory_append',
  ...
  developer: [
    ...
    'memory_append',
    'check_process',
    'wait_for_process', // v6.0/v19.0: 查询/等待后台进程
    'rfc_propose', // v5.5: RFC 设计变更提案
    ...
    'deploy_compose_down',
    'deploy_dockerfile',
    'deploy_dockerfile_generate',
    'deploy_health_check',
    'deploy_find_port',
    'deploy_nginx_generate',
    // v14.0: Supabase (开发相关)
    'supabase_status',
    'supabase_migration_create',
    'supabase_db_pull',
    'supabase_gen_types',
