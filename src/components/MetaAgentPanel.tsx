 ...
 *
 * 状态托管在 app-store.metaAgentPanelOpen
 */
    ...
    setTimeout(() => {
      setMessages(prev => [
        ...prev,
        {
          ...
          role: 'assistant',
          content: `收到："${userMsg.content.slice(0, 40)}${userMsg.content.length > 40 ? '...' : ''}"。正在分析...`,
          timestamp: Date.now(),
        },
      ]);
      setSending(false);
          ...
          <div className="flex-1 overflow-y-auto px-2 py-2 space-y-2">
            ...
            {sending && (
              <div className="flex justify-start">
                <div className="bg-slate-800/80 rounded-xl rounded-bl-sm px-3 py-2 text-xs text-slate-500">
