...
|------|------|
| 🗺️ 全景 | 总控制台，查看项目进度和架构 |
| ✨ 许愿 | 输入需求，和管家对话（支持 4 种模式：工作/闲聊/深度/管理） |
| 📋 看板 | Feature 任务看板 |
| 📄 文档 | 自动生成的设计文档 |
...
在许愿页的会话列表中，可以切换不同的对话模式：

| 模式 | 用途 |
|------|------|
| 💼 工作模式 | 正式提需求，管家会自动创建任务并委派团队执行 |
| 💬 闲聊模式 | 轻松聊天、技术咨询，不执行任何任务 |
| 🧐 深度讨论 | 深入分析某个问题，可以写文件和派发任务 |
| ⚙️ 管理模式 | 直接通过对话管理团队成员、工作流、项目配置 |
